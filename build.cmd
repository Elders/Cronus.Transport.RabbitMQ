...
%FAKE% %NYX% "target=%TARGET%" appName=Elders.Cronus.Transport.RabbitMQ appSummary=%SUMMARY% appDescription=%DESCRIPTION% nugetPackageName=Cronus.Transport.RabbitMQ