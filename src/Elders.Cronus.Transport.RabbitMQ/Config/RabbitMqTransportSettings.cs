...
namespace Elders.Cronus.Pipeline.Transport.RabbitMQ.Config
{
    ...
    public interface IRabbitMqTransportSettings
    {
    ...
    public class RabbitMqSettings : IRabbitMqTransportSettings
    {
    ...
    public class RabbitMqTransportSettings : SettingsBuilder, IRabbitMqTransportSettings, IPipelineTransportSettings
    {
